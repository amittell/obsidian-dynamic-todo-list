...
-   The "Completed task" should be marked as complete and in the completed section at the bottom.
...
```md
- [ ] #todo A new task with #todo tag
```

4. Create a new note called "Tasks_still.md" with

```md
- [ ] #tasks A new task with #tasks tag
```
...
**Steps:**
1. Open Settings > Dynamic Todo List.
2. Toggle "Enable URL links" to on.
3. Create a task with a URL: `- [ ] #tasks Visit https://obsidian.md`

**Expected:**
- Clicking on the URL should open the URL in a browser.

**2.7 Folder Filters (Include)**
**Steps:**
...
**2.9 Test combinations of include and exclude filters.**

**2.10 Test adding and removing include/exclude filters.**
...
**Steps:**
1. Open the Dynamic Todo List View.
2. Click on the text of a task.

**Expected:**
- Obsidian should open the source note containing the task.
- The cursor should be positioned at the beginning of the task line.

### 10. Modal View

**Steps:**
1. Create a note with tasks.
2. Run the command `app.commands.executeCommandById('dynamic-todo-list:open-modal')`

**Expected:**
- A modal should open displaying the tasks.
- The tasks should be grouped by file.
